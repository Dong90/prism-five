...
# TEST: M14 test: context / learnings / memory
...
- **T-01**: context.test.ts: saveContext/loadContext roundtrip + edge cases (5 tests) `[passed]`
- **T-02**: learnings.test.ts: add/list with category filter (4 tests) `[passed]`
- **T-03**: memory.test.ts: CRUD + backup mechanism (5 tests) `[passed]`
- **T-04**: Full regression: 129 tests across 20 files, all green `[passed]`

...
# INTEGRATION: M15 Token Integration
...
- **feat**: M15: add TokenBudget class with track/check/usage/bump/estimate for per-role token management
- **feat**: M15: pipeline.continue() integrated token budget check — exceeds quota → gate blocked
